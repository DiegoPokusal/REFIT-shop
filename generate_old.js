...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .detail-size-label { font-size: 0.55rem; letter-spacing: 0.2em; color: var(--text-muted); text-transform: uppercase; margin-bottom: 10px; }
  .detail-sizes { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 12px; }
...
<p style="font-size:0.6rem;color:#555;letter-spacing:0.1em;margin-bottom:16px;"> vintage kus — môže obsahovať drobné znaky nosenia.</p>
      <p class="detail-size-label">Veľkosť</p>
